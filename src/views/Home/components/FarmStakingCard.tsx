        ...
        const wasAdded = await provider.request({
          ...
          params: {
            ...
            options: {
              ...
              symbol: 'ICE',
              decimals: '18',
              image: 'https://www.PolyIce.net/images/egg/3.png',
            },
          },
        })
      ...
      <CardBody>
        ...
        <Actions>
          <Button onClick={addWatchJaguarToken} size="sm" mb={2}>
            + Add ICE to <img style={{ marginLeft: 8 }} width={16} src="https://jaguarswap.com/images/tokens/metamask.png" alt="metamask logo" />
          </Button>
          {account ? (
            <Button
              id="harvest-all"
